import { MaterialPalette, MaterialColors } from './ExpoMaterialDynamicColors.types'
import { useMaterialPalette } from './useMaterialPalette'
...
export function useMaterialTheme(): {
  ...
  return paletteToColors(useMaterialPalette())
}
